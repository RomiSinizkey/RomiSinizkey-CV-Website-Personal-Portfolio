import "../../styles/components/aiLoader.css";
...
export default function AILoader({ size = 64 }: LoaderProps) {
  const style = {
    "--ai-loader-btn-size": `${Math.max(72, Math.round(size * 2.0))}px`,
    "--ai-loader-icon-size": `${Math.max(24, Math.round(size * 0.82))}px`,
    "--ai-loader-title-size": `${Math.max(8, Math.round(size * 0.17))}px`,
    "--ai-loader-subtitle-size": `${Math.max(10, Math.round(size * 0.24))}px`,
  } as CSSProperties;

  return (
    <div className="ai-loader-root" style={style}>
      <div className="ai-loader-button-container">
        <button
          type="button"
          className="ai-loader-brutalist-button ai-loader-openai ai-loader-button-1"
          tabIndex={-1}
          aria-hidden="true"
        >
          <div className="ai-loader-openai-logo" aria-hidden="true">
            <svg
              className="ai-loader-openai-icon"
              viewBox="0 0 24 24"
          ...
          <div className="ai-loader-button-text-wrap">
            <span>Need Help?</span>
            <span>ASK ME</span>
          </div>
        </button>
